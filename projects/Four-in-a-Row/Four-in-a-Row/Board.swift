    ...
    func isWin(for player: Player) -> Bool {
        ...
        for row in 0 ..< Board.width {
            for col in 0 ..< Board.width {
                ...
                if squaresMatch(initialChip: chip, row: row, col: col, moveX: 0, moveY: 1) { return true }
                if squaresMatch(initialChip: chip, row: row, col: col, moveX: 1, moveY: 1) { return true }
                if squaresMatch(initialChip: chip, row: row, col: col, moveX: 1, moveY: -1) { return true }
            }
        }
