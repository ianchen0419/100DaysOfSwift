...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        background.position = CGPoint(x: 514, y: 384)
        ...
        physicsWorld.contactDelegate = self // tell us when a collision happened
    ...
    func loadLevel() {
        guard let levelURL = Bundle.main.url(forResource: "level1", withExtension: "txt") else {
            fatalError("Could not find leve1.txt in the app bundle.")
        }
        guard let levelString = try? String(contentsOf: levelURL) else {
            fatalError("Could not load leve1.txt from the app bundle.")
        }
