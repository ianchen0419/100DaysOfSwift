...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        rockPhysic = SKPhysicsBody(texture: rockTexture, size: rockTexture.size())
    ...
    func createPlayer() {
        ...
        let runOver = SKAction.repeatForever(animation)
    ...
    func createRocks() {
        ...
        topRock.physicsBody = rockPhysic.copy() as? SKPhysicsBody
        topRock.physicsBody?.isDynamic = false
        topRock.zRotation = .pi
        topRock.xScale = -1.0
        
        let bottomRock = SKSpriteNode(texture: rockTexture)
        bottomRock.physicsBody = rockPhysic.copy() as? SKPhysicsBody
