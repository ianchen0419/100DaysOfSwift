...
// print(name[3]) // won't work
let letter = name[name.index(name.startIndex, offsetBy: 3)] // work well
...
languages.contains(where: input.contains) // same work with input.containsAny(of: languages)
